...
export default function Nav() {
    return(
        ...
        <nav className="text-lg text-white items-center justify-center px-40">
            <NavLink to="/events"className="px-10 hover:text-blue-400">egne events</NavLink>
            <NavLink to="/profil"className="px-10 hover:text-blue-400">Profil</NavLink>
            <NavLink to="/add-event"className="px-10 hover:text-blue-400">Tilføj Event</NavLink>
        </nav>
        </div>
    )
};